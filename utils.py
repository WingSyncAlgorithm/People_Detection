...
class KeyPoints:
    ...
    def detectPoints(self, frame):  # Detects the keypoints of an image
        ...
        predict = results[0]['predictions'][0][0]['keypoints']
...
class FeatureExtractor:
    ...
    def __init__(self):
        ...
        self.angle_weights = np.ones((6, 1))  # Weights for angles
